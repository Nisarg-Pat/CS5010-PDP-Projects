...
public class DungeonControllerImplTest4 {
  ...
  public void testConstructorFail() {
    ...
    try {
      new DungeonControllerImpl(null, out, model);
      fail();
    ...
    try {
      new DungeonControllerImpl(in, null, model);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("The arguments to controller cannot be null.", e.getMessage());
    }
    ...
    try {
      new DungeonControllerImpl(in, out, null);
      fail();
    } catch (IllegalArgumentException e) {
      assertEquals("The arguments to controller cannot be null.", e.getMessage());
    }
  ...
  public void testFailingReadable() {
    ...
    Appendable out = new StringBuilder();
    DungeonController controller = new DungeonControllerImpl(failing, out, model);
    try {
      controller.start();
      fail();
    } catch (IllegalStateException e) {
  ...
  public void testInvalidInput() {
    ...
    Appendable out = new StringBuilder();
    DungeonController controller = new DungeonControllerImpl(in, out, model);
    controller.start();
